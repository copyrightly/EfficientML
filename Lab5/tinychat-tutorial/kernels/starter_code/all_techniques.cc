    ...
    for (int row = 0; row < m; row++) {
        for (int col = mat_args->start_j; col < mat_args->end_j; col++) {
            ...
            for (int q = 0; q < num_block; q += 4) {
                ...
                int8x16_t w0_de_16 = vreinterpretq_s8_u8(vshrq_n_u8(w0, 4));
                int8x16_t w1_de_0 = vreinterpretq_s8_u8(vandq_u8(w1, mask_low4bit));
                int8x16_t w1_de_16 = vreinterpretq_s8_u8(vshrq_n_u8(w1, 4));
                int8x16_t w2_de_0 = vreinterpretq_s8_u8(vandq_u8(w2, mask_low4bit));
                int8x16_t w2_de_16 = vreinterpretq_s8_u8(vshrq_n_u8(w2, 4));
                int8x16_t w3_de_0 = vreinterpretq_s8_u8(vandq_u8(w3, mask_low4bit));
                int8x16_t w3_de_16 = vreinterpretq_s8_u8(vshrq_n_u8(w3, 4));
                ...
                // int32x4_t int_sum0, int_sum1, int_sum2, int_sum3; //!!! Need to initialize with 0!!!
